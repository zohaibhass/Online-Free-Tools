...
export const tools: Tool[] = [
  // Developer Tools (12)
  {
    ...
    featured: true,
    seoTitle: 'JSON Formatter Online - Validate, Beautify & Minify',
    seoDescription: 'Format, validate, and beautify JSON online instantly. Paste minified JSON and get indented output with error detection. Fast and private.',
  ...
  },
  {
    ...
    seoDescription: 'Decode Base64 strings or encode text online instantly. This free Base64 encoder decoder runs entirely in your browser.',
  ...
  },
  {
    ...
    seoTitle: 'UUID / GUID Generator Online - v4, v1 & v7',
    seoDescription: 'Create random UUID v4, v1, and GUID identifiers online. Perfect for database keys, test data, and distributed systems.',
  ...
  },
  {
    ...
    seoTitle: 'BMI Calculator Online - Check Your Body Mass Index',
    seoDescription: 'Calculate your Body Mass Index online using metric or imperial units. See your category and ideal weight range instantly.',
  ...
  // Pixels to Inches Converter Cluster (6)
  {
    ...
    featured: true,
    seoTitle: 'Pixels to Inches Converter Online - Free PX Tool',
    seoDescription: 'Convert pixels to inches online instantly. Supports 72, 96, 150, and 300 DPI with custom resolution settings.',
  ...
  },
  {
    ...
    featured: true,
    seoTitle: 'URL Slug Generator Online - SEO Friendly Slugs',
    seoDescription: 'Create SEO-friendly URL slugs from titles and text online. Bulk mode, stop-word removal, and accent handling included.',
  ...
  },
  {
    ...
    featured: true,
    seoTitle: 'Cron Expression Generator Online - Free Builder',
    seoDescription: 'Build any cron schedule online by typing plain English or using visual selectors. Supports standard and Quartz cron syntax.',
