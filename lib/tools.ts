...
export const toolGuideContent: Record<string, { sections: ToolGuideSection[]; relatedTools: string[]; faq?: { question: string; answer: string }[] }> = {
  ...
  'regex-tester': {
    sections: [
      ...
      {
        heading: 'Common regex patterns you can reuse',
        paragraphs: [
  ...
  'sql-formatter': {
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Consistent formatting makes SQL easier to read, review, and maintain, whether the query is 10 lines or 1,000. Here are the conventions most teams follow:',
          'Uppercase keywords: Write reserved words like SELECT, FROM, WHERE, JOIN, and ORDER BY in uppercase so they stand out from column and table names. Mixed-case keywords are the most common readability mistake in hand-written SQL.',
          'One clause per line: Put each major clause (SELECT, FROM, JOIN, WHERE, GROUP BY, HAVING, ORDER BY, LIMIT) on its own line. This makes the structure of the query visible at a glance and reduces merge conflicts when multiple developers edit the same query.',
          'Indent subqueries and joins: Subqueries, derived tables, and conditions inside ON clauses should be indented one level deeper than the clause they belong to. Consistent indentation of 2, 3, or 4 spaces (pick one and stick to it) mirrors good code style.',
          'List columns deliberately: In a SELECT, put one column per line for long lists, and use table aliases (t.column) when a query joins multiple tables so it is clear where each column comes from.',
          'Format conditions consistently: Use lowercase boolean operators (and, or, not) or uppercase (AND, OR, NOT) and keep the same choice everywhere. Align comparison operators within a WHERE block when you can.',
          'Keep it readable, not clever: Prefer clarity over compactness. A slightly longer query that a teammate can understand in seconds is better than a dense one-liner that saves a few characters.',
        ],
      },
      {
        heading: 'Common errors and how to fix them',
  ...
  'password-generator': {
    sections: [
      ...
      {
        heading: 'Why password length and entropy matter',
        paragraphs: [
          'Password strength is measured by entropy, which is the number of possible combinations an attacker has to try before guessing your password. Each added character multiplies the possibilities, which is why a 16-character random password is dramatically harder to crack than an 8-character one, even when both use the same character set.',
          'A good rule of thumb: an 8-character password using only lowercase letters has roughly 26^8 combinations, while a 12-character password with uppercase, lowercase, digits, and symbols has about 95^12 combinations. The second is many trillions of times harder to brute force. Modern cracking tools try millions of combinations per second, so short passwords fall within minutes, while long random ones can take centuries.',
          'This is why the generator defaults to a generous length and mixes all four character classes. Avoid the temptation to make passwords short so they are easier to type; instead, rely on a password manager to remember them for you. The few extra characters are what keep your accounts safe.',
        ],
      },
      {
        heading: 'Related tools',
  ...
  'bmi-calculator': {
    sections: [
      ...
      {
        heading: 'Height-to-weight healthy range lookup',
        paragraphs: [
  ...
  'cron-expression-generator': {
    sections: [
      ...
      {
        heading: 'Cron expression cheat sheet (10+ common patterns)',
        paragraphs: [
...
export const tools: Tool[] = [
  // Developer Tools (12)
  {
    ...
    icon: 'Braces',
    slug: 'json-formatter',
    keywords: ['json formatter online', 'json validator online', 'json beautifier', 'format json online', 'pretty print json', 'how to format json', 'validate json syntax online', 'json', 'format', 'validate', 'minify'],
    featured: true,
    seoTitle: 'JSON Formatter & Validator (Beautify, Minify, Validate Syntax)',
    seoDescription: 'Format, beautify, and validate JSON syntax online with error line/column reporting. Minify or pretty-print API and config JSON instantly.',
    h1: 'JSON Formatter & Validator — Beautify, Minify & Validate JSON Online',
  },
  {
    id: 'jwt-decoder',
    name: 'JWT Decoder',
    ...
    featured: true,
    seoTitle: 'JWT Decoder Online - Decode Tokens & Claims Instantly',
    seoDescription: 'Decode any JWT token instantly and inspect headers, payloads, claims, and expiration dates. 100% browser-based - your tokens never leave your device.',
...

  {
    ...
    seoTitle: 'Regex Tester Online - Test & Validate Regular Expressions',
    seoDescription: 'Build, test, and validate regular expressions online with real-time matching and highlighting. Supports global, case-insensitive, and multiline flags.',
  ...
  },
  {
    ...
    seoTitle: 'SQL Formatter Online - Beautify Queries Instantly',
    seoDescription: 'Beautify and format messy SQL queries online instantly. Supports MySQL, PostgreSQL, and more with clean, properly indented output.',
  ...
  },
  {
    ...
    icon: 'Binary',
    slug: 'base64-encoder',
    keywords: ['base64 decode online', 'base64 encode online', 'base64 encoder decoder', 'decode base64 string', 'base64 converter', 'what is base64 encoding used for', 'base64 encode vs encrypt difference', 'base64 character limit', 'base64 image data uri', 'base64', 'encode', 'decode'],
    seoTitle: 'Base64 Encoder & Decoder (What is Base64, Encode vs Encrypt, Data Limits)',
    seoDescription: 'Encode text to Base64 or decode Base64 strings online. Learn what Base64 is used for, the encode vs encrypt difference, byte expansion, and padding rules.',
    h1: 'Base64 Encoder & Decoder — Convert Text & Data to Base64 Online',
  },
  {
    id: 'url-encoder',
    ...
    seoDescription: 'Encode special characters for URLs and query parameters, or decode percent-encoded strings back to readable text. Free and instant.',
  ...
  },
  {
    ...
    seoTitle: 'MD5 & SHA256 Hash Generator Online - Free',
    seoDescription: 'Generate SHA256, SHA1, SHA512, and MD5 hashes instantly online. Browser-based - your data never leaves your device.',
  ...
  },
  {
    ...
    seoTitle: 'HEX to RGB & HSL Color Converter Online',
    seoDescription: 'Convert between HEX, RGB, and HSL color formats online instantly. Perfect for web designers and developers.',
  ...
  },
  {
    ...
    seoTitle: 'JavaScript & CSS Minifier Online - Free',
    seoDescription: 'Minify JavaScript, CSS, and HTML online to reduce file sizes by up to 70% and speed up your website. Free and browser-based.',
  ...
  },
  {
    ...
    seoTitle: 'Diff Checker Online - Compare Text Side by Side',
    seoDescription: 'Compare two texts side by side online. This free diff tool highlights every difference - perfect for code review and documents.',
  ...
  },
  {
    ...
    seoTitle: 'XML Formatter Online - Pretty Print & Validate',
    seoDescription: 'Format, beautify, and validate XML documents online. Get properly indented output with syntax error detection.',
  ...
  },
  {
    ...
    seoTitle: 'UUID / GUID Generator (v4, v1, v7) for Database Keys',
    seoDescription: 'Generate random UUID v4, v1, and GUID identifiers online for database primary keys, test data, and distributed systems. Bulk generation supported.',
    h1: 'UUID Generator — Free GUID & UUID v4 Generator for Database Keys',
  },
  ...
  // Document & Media Tools (7)
  {
    ...
    seoTitle: 'Word Counter Online - Count Words & Characters',
    seoDescription: 'Count words, characters, sentences, and paragraphs online instantly. Includes reading time estimates for essays and articles.',
  ...
  },
  {
    ...
    seoTitle: 'QR Code Generator Online - Free, No Watermark',
    seoDescription: 'Create custom QR codes for URLs, text, email, and phone numbers online. Download as PNG or SVG with no watermarks.',
  ...
  },
  {
    ...
    seoTitle: 'Markdown Editor Online - Live Preview & HTML Export',
    seoDescription: 'Write Markdown with live preview and export formatted HTML online. Perfect for documentation, notes, and README files.',
  ...
  },
  {
    ...
    featured: true,
    seoTitle: 'Image Compressor Online - Reduce JPEG & PNG Size',
    seoDescription: 'Reduce JPEG, PNG, and WebP file sizes online without losing quality. Instant compression in your browser with no upload limits.',
...

  {
    ...
    seoTitle: 'Text to Speech Online - Free Voice Converter',
    seoDescription: 'Convert text to speech online. Choose a voice, adjust speed and pitch, and download recordings as webm files.',
  ...
  },
  {
    ...
    seoDescription: 'Convert JSON array data into spreadsheet-ready CSV format online. Download or copy your results instantly.',
  ...
  },
  {
    ...
    seoDescription: 'Transform plain text into clean HTML markup online. Supports headings, paragraphs, and full document output.',
  ...
  // Calculator Tools (8)
  {
    ...
    seoTitle: 'Unit Converter Online - Length, Weight & Volume',
    seoDescription: 'Convert between length, weight, volume, temperature, and more online. Fast and accurate for students and professionals.',
  ...
  },
  {
    ...
    seoTitle: 'Loan Calculator Online - Payments & Amortization',
    seoDescription: 'Estimate monthly payments, total interest, and full amortization schedules for any loan online. Free and instant.',
  ...
  },
  {
    ...
    seoTitle: 'Percentage Calculator Online - Free & Fast',
    seoDescription: 'Find percentage increases, decreases, ratios, and reverse values online. Fast and accurate for shopping and business.',
  ...
  },
  {
    ...
    seoTitle: 'Mortgage Calculator Online - Payments & Amortization',
    seoDescription: 'Estimate monthly payments, compare loan options, and view full amortization schedules online. Plan your home purchase.',
  ...
  },
  {
    ...
    seoTitle: 'Age Calculator Online - How Old Am I? Free',
    seoDescription: 'Calculate your exact age in years, months, and days from your date of birth online. Also computes time between dates.',
  ...
  },
  {
    ...
    icon: 'Activity',
    slug: 'bmi-calculator',
    keywords: ['bmi calculator', 'body mass index calculator', 'bmi calculator for men', 'bmi calculator for women', 'bmi chart in kg and cm', 'bmi chart for men over 40', 'healthy bmi range by age and height', 'calculate bmi in kg and meters', 'bmi', 'health', 'weight', 'height'],
    seoTitle: 'BMI Calculator & Chart for Men, Women & Age (kg/cm & ft/in)',
    seoDescription: 'Calculate Body Mass Index in kg/cm or ft/in and see healthy weight ranges per height. Includes BMI chart context for men, women, and age.',
    h1: 'BMI Calculator & Chart — Calculate Body Mass Index in kg/cm or ft/in',
  },
  {
    ...
    seoTitle: 'Discount Calculator Online - Percent Off & Savings',
    seoDescription: 'Find sale prices and savings instantly. Calculate percentage off or fixed amount discounts and see exactly what you save.',
  ...
  },
  {
    ...
    seoTitle: 'Tip Calculator Online - Split Bills & Tips',
    seoDescription: 'Calculate tip amounts, split bills among friends, and see per-person totals online. Perfect for restaurants and group dining.',
  ...
  // Pixels to Inches Converter Cluster (6)
  {
    ...
    featured: true,
    seoTitle: 'Pixels to Inches Converter (1080p, 1920x1080, 4K at 300, 96, 72 DPI)',
    seoDescription: 'Convert PX to inches for print & screen at 72, 96, 150, or 300 DPI. Includes 1080p, 1920x1080, 4K, and 8.5x11 inches reference conversions.',
    h1: 'Pixels to Inches Converter — Convert PX to Inches for Print & Screen',
  },
  ...
  // Utility Tools (8)
  {
    ...
    seoTitle: 'Password Generator Online - Strong Random Passwords',
    seoDescription: 'Create strong, random, and secure passwords online with custom length and character sets. Browser-based and private.',
  ...
  },
  {
    ...
    seoTitle: 'Random Name Generator Online - 1000+ Names',
    seoDescription: 'Generate random full names online. Create 1 to 50 names at once for characters, projects, or test data.',
  ...
  },
  {
    ...
    seoTitle: 'Todo List Online - Free Task Manager',
    seoDescription: 'Manage tasks online with priorities and due dates. Add, edit, complete, and filter tasks - data persists in your browser.',
  ...
  },
  {
    ...
    seoTitle: 'Online Timer & Stopwatch - Free Countdown',
    seoDescription: 'Switch between countdown timer and stopwatch online with start, pause, and reset controls. Free and easy to use.',
  ...
  },
  {
    ...
    seoTitle: 'Dice Roller Online - d4, d6, d20 & d100',
    seoDescription: 'Roll 1-5 dice online with d4, d6, d8, d10, d12, d20, or d100 sides. Roll history is saved in your browser.',
  ...
  },
  {
    ...
    seoTitle: 'Coin Flipper Online - Flip a Coin or Yes/No',
    seoDescription: 'Flip 1, 3, or 5 coins online with 3D animation. Track streaks, view heads/tails stats, and toggle Yes/No mode.',
  ...
  },
  {
    ...
    seoTitle: 'Morse Code Translator Online - Encode & Decode',
    seoDescription: 'Convert text to Morse code or decode Morse code back to text online instantly. Free translator and generator.',
  ...
  },
  {
    ...
    seoTitle: 'Online Calculator - Free Arithmetic Math Tool',
    seoDescription: 'Compute arithmetic expressions online instantly. Enter math formulas with addition, subtraction, multiplication, and division.',
  ...
  },
  {
    ...
    icon: 'Link2',
    slug: 'slug-generator',
    keywords: ['slug generator', 'url slug generator', 'seo slug generator', 'text to slug converter', 'generate slug from title', 'string to slug', 'slugify text online', 'permalink generator', 'convert title to url slug', 'how to make seo friendly url slugs', 'bulk url slug generator', 'remove accents and stop words from slug'],
    featured: true,
    seoTitle: 'URL Slug Generator for SEO (Clean Permalinks, Accent Removal, Bulk Slugs)',
    seoDescription: 'Create clean, SEO-friendly URL permalinks from titles with bulk mode, accent removal, and stop-word stripping.',
    h1: 'URL Slug Generator — Create Clean, SEO-Friendly URL Permalinks',
  },
  {
    ...
    keywords: ['cron expression generator', 'cron job expression generator', 'generate cron expression', 'quartz cron expression generator', 'cron expression every 5 minutes', 'cron expression daily at midnight', 'crontab guru alternative', 'cron schedule format examples', 'cron job calculator', 'cron schedule format', 'cron translator', 'cron', 'schedule', 'scheduler', 'crontab', 'cron job'],
    featured: true,
    seoTitle: 'Cron Expression Generator & Examples (Every 5 Mins, Daily at Midnight, Quartz & Unix)',
    seoDescription: 'Build, translate, and validate Unix and Quartz cron schedules. Includes common cron examples for every 5 minutes, daily at midnight, and more.',
    h1: 'Cron Expression Generator — Build, Translate & Validate Cron Schedules',
  },
]
